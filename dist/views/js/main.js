...
//	var items = document.querySelectorAll('.mover');
	...
	for (var i = 0; i < items.length; i++) {
		if (count == 6) count =1;
		var phase = Math.sin((scroll / 1250) + count);
...
/*
	changed number pizzas created from 200 to 64
	even though all 64 may not show on the screen
	it scales dowm and works for mobile
